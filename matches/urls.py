...
urlpatterns = patterns('',
    ...
    url(r'^view-matches/(?P<patient_id>\d+)/(?P<scroll_pixel>\d+)/$', views.view_matches),
    ...
    url(r'^(?P<match_id>\d+)/match-detail/(?P<patient_id>\d+)/(?P<scroll_pixel>\d+)/$', views.match_detail),
